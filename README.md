...
| scope| Defines the intention of using the `Card-Android`. | True  | String| ` var scope:String = "Token" //This means you will get a Tap token to use afterwards` OR ` var scope:String = "Authenticate" //This means you will get an authenticated Tap token to use in our charge api right away`  |
